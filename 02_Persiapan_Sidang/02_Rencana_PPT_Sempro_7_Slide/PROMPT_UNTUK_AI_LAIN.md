# 📋 PROMPT SIAP COPY-PASTE UNTUK AI LAIN (ChatGPT / Claude / Gamma / Cursor)
### *Instruksi Pembuatan Slide Deck Seminar Proposal 7 Slide*

> [!SUMMARY] Tujuan Dokumen Ini
> Salin (*copy*) seluruh teks di dalam blok kode di bawah ini, lalu tempel (*paste*) ke AI pilihan Anda (misalnya Claude, ChatGPT, Gamma App, atau Cursor) untuk membuat presentasi PPTX atau kode slide yang 100% presisi sesuai arahan dosen pembimbing ([[07_Review_&_Audit/Revisi_Dosen/|Dr. Fredella Colline]]).

---

```text
Halo! Anda adalah Senior Presentation Designer dan Academic Coach untuk sidang skripsi Fakultas Ekonomi dan Bisnis (FEB) Universitas Kristen Krida Wacana (UKRIDA).

Tugas Anda: Buatkan saya presentasi Seminar Proposal (Sempro) yang RINGKAS, PADAT, dan TEPAT 7 SLIDE sesuai arahan dosen pembimbing saya (Ibu Dr. Fredella Colline). 

PANDUAN DESAIN:
1. Format: 16:9 Widescreen.
2. Tema Visual: FinTech Executive Dark Mode (Latar belakang dark navy #0B0F19, kontainer kartu #1E293B dengan border halus #334155, teks putih #F8FAFC, aksen Cyan #06B6D4, Emerald Green #10B981, dan Amber #F59E0B).
3. Aturan Konten: JANGAN membuat teks panjang (NO wall of text). Gunakan card-based layout, bullet points ringkas, badge angka sorotan, dan ikon indikator.
4. Istilah Asing: Selalu cetak miring (italic), contoh: impulsive buying, booster pack, pseudo-set framing, mean-centering.
5. Speaker Notes: Wajib sertakan catatan pembicara (speaker notes / talking points) di setiap slide (durasi bicara ~1 - 1,5 menit per slide).

BERIKUT ADALAH STRUKTUR DETAIL 7 SLIDE YANG HARUS DIBUAT:
...
- Speaker Notes: Salam pembuka resmi, perkenalkan diri, bacakan judul skripsi dan nama dosen pembimbing dengan tenang dan tegas (~45 detik).

--------------------------------------------------
SLIDE 2: LATAR BELAKANG — KONTEKS INDUSTRI & FENOMENA MASALAH
--------------------------------------------------
- Judul: LATAR BELAKANG: FENOMENA BISNIS & MASALAH
...
--------------------------------------------------
- Judul: LATAR BELAKANG: RESEARCH GAP & KEBARUAN
- Subjudul: Kesenjangan Temuan Empiris & Novelty Model Riset
- Kolom Kiri (Inkonsistensi Gap Empiris):
...
--------------------------------------------------
SLIDE 4: TINJAUAN PUSTAKA — TEORI & KONSTELASI VARIABEL
--------------------------------------------------
...
--------------------------------------------------
SLIDE 6: METODE PENELITIAN & ANALISIS DATA
--------------------------------------------------
- Judul: METODE PENELITIAN & STRATEGI ANALISIS DATA
...
--------------------------------------------------
- Judul: SEKIAN & TERIMA KASIH
- Subjudul: Usulan Penelitian Proposal Skripsi — S1 Manajemen FEB UKRIDA
- Kontribusi Riset: Memperkaya literatur Behavioral Finance pada pasar hobi alternatif serta menjadi landasan penguatan literasi keuangan generasi muda.
- Callout: Sesi Tanya Jawab (Q&A) Dibuka.
- Identitas: Arthur Reezan | NIM: 312023002 | Program Studi S1 Manajemen FEB UKRIDA
- Speaker Notes: Ucapkan terima kasih secara santun dan percaya diri, lalu kembalikan forum kepada Ketua Sidang (~30 detik).

OUTPUT YANG SAYA INGINKAN:
Berikan saya keluaran berupa kode (skrip Python `python-pptx`, kode HTML slide interaktif, atau format slide PowerPoint) yang siap saya gunakan sekarang juga!
```
