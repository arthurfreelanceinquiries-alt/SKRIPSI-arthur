...
\begin{figure}[htbp]
  ...
  \vspace{0.1cm}
  {\footnotesize \textit{Sumber: Statista Research dan Laporan Keuangan Tahunan Korporat (2024)}\par}
\end{figure}
...
Sebagaimana disajikan pada Gambar~\ref{fig:pricecharting_disparity}, kartu berkondisi sempurna (\emph{PSA 10 Gem Mint}) mengalami apresiasi nilai pasar sekunder yang spektakuler, berkisar antara 2,0 kali lipat pada kartu langka utama (\emph{Charizard VMAX \#SV107}) hingga menembus 23,7 kali lipat (\emph{Kyogre \#21}) dan 26,0 kali lipat (\emph{Reshiram \#17}) dibandingkan kondisi kartu mentah tanpa sertifikasi \citep{pricecharting2024}. Fenomena disparitas harga yang masif ini memperkuat ekspektasi keuntungan finansial dan membuktikan secara empiris bekerjanya motif spekulasi finansial (\emph{Speculative Motive} / $X_3$) di mana konsumen terdorong membeli \emph{booster pack} acak demi mengejar potensi keuntungan arbitrase \emph{grading} (\emph{grading arbitrage}).
...
\begin{enumerate}
  ...
  \begin{itemize}
    \item \emph{Temuan A (Positif dan Signifikan):} Studi kuantitatif eksperimental oleh \citet{gao2014completing}, \citet{barasz2017pseudo}, \citet{tan2024ketidakpastian}, dan \citet{dewi2024understanding} membuktikan bahwa hasrat melengkapi himpunan (\emph{collection-goal tipping point effect}) dan persepsi ketidaklengkapan memicu ketegangan psikologis (\emph{Zeigarnik Effect}) yang secara signifikan mempercepat transaksi pembelian spontan demi menutup celah kekosongan koleksi.
    \item \emph{Temuan B (Negatif / Tidak Signifikan):} Sebaliknya, riset empiris perilaku kolektor oleh \citet{long2000consuming} dan \citet{spero2004approach} menemukan bahwa dorongan melengkapi set tidak selalu meningkatkan pembelian impulsif pada kemasan acak; kolektor matang dan berpengalaman (\emph{mature collectors}) justru menolak pembelian spekulatif pada produk acak dan menerapkan strategi belanja terencana untuk membeli kartu lepasan (\emph{single cards}) di pasar sekunder.
  ...
  \begin{itemize}
    \item \emph{Temuan A (Positif dan Signifikan):} Penelitian empiris dalam kerangka keuangan perilaku oleh \citet{shiller2000irrational}, \citet{baur2018bitcoin}, \citet{aryadi2024personal}, dan \citet{colline2024biases} membuktikan bahwa ekspektasi keuntungan modal (\emph{capital gain}) dan bias optimisme berlebih (\emph{overoptimism bias}) mendorong transaksi pembelian alternatif aset secara spontan dan agresif.
    \item \emph{Temuan B (Negatif / Tidak Signifikan):} Sebaliknya, riset keputusan investasi oleh \citet{barber2008all} dan landasan pasar efisien \citet{fama1970efficient} menunjukkan bahwa motif spekulasi finansial sering kali diimbangi oleh kalkulasi risiko kerugian modal (\emph{downside risk}), yang justru menumbuhkan kehati-hatian kognitif dan mencegah tindakan belanja spontan tanpa perhitungan mendalam.
  ...
  \begin{itemize}
    ...
    \item \emph{Temuan B (Pengaruh Lemah / Bypass Regulasi Diri):} Namun, studi perilaku konsumsi pengalaman oleh \citet{hirschman1982hedonic} serta pengamatan klasik \citet{stern1962significance} menemukan bahwa kontrol diri sering kali lumpuh (\emph{cognitive bypass}) ketika stimulus lingkungan toko dan rangsangan visual produk terjadi secara mendadak dan luar biasa intens, sehingga kontrol diri gagal meredam desakan belanja impulsif.
  ...
  \begin{itemize}
    \item \emph{Temuan A (Memperlemah Pengaruh / Buffer Efektif):} Riset empiris oleh \citet{sultan2012building} dan \citet{apidana2022peran} membuktikan bahwa kontrol diri secara nyata memoderasi dan memperlemah pengaruh motif hedonis terhadap pembelian impulsif, di mana konsumen berdaya regulasi tinggi mampu membatasi belanja meskipun merasakan kesenangan belanja yang intens.
    \item \emph{Temuan B (Tidak Mampu Memoderasi / Buffer Gagal):} Sebaliknya, temuan \citet{prasetio2021hedonic} serta \citet{zheng2019impact} menunjukkan bahwa kontrol diri tidak mampu memoderasi dorongan belanja hedonis ketika kenikmatan belanja menciptakan luapan emosional yang terlalu dominan.
  ...
  \begin{itemize}
    \item \emph{Temuan A (Memperlemah Pengaruh / Buffer Efektif):} Riset oleh \citet{lienardy2024role} dan \citet{artadita2024how} menemukan bahwa kapasitas kontrol diri mampu memoderasi dan menahan desakan perilaku konsumtif pada produk hobi dan game daring melalui penetapan batas pengeluaran pribadi yang ketat.
    \item \emph{Temuan B (Tidak Mampu Memoderasi / Dorongan Melampaui Kontrol Diri):} Sebaliknya, riset antropologi koleksi oleh \citet{belk1995collecting} dan \citet{barasz2017pseudo} menunjukkan bahwa obsesi terhadap kelengkapan himpunan dapat berkembang menjadi dorongan kuasi-kompulsif yang membungkam pertimbangan kontrol diri individu.
  ...
  \begin{itemize}
    \item \emph{Temuan A (Memperlemah Pengaruh / Literasi Keuangan & Kontrol Diri Meredam Spekulasi):} Penelitian oleh \citet{katauke2023financial} serta \citet{colline2024biases} membuktikan bahwa literasi keuangan dan kontrol diri mampu meredam desakan spekulatif dengan mengarahkan orientasi perilaku pada perencanaan alokasi dana jangka panjang.
    \item \emph{Temuan B (Tidak Mampu Memoderasi / Euforia Pasar Melumpuhkan Kontrol Diri):} Sebaliknya, riset gelembung spekulasi oleh \citet{shiller2000irrational} dan studi transaksi komunitas kartu oleh \citet{aryadi2024personal} membuktikan bahwa ilusi keuntungan lelang sekunder kerap melumpuhkan kontrol diri rasional konsumen.
...
1 & $X_1 \rightarrow Y$ (\emph{Hedonic Motivation} ke \emph{Impulsive Buying}) & \citet{arnold2003hedonic}; \citet{gueltekin2012influence}; \citet{pranggabayu2022pengaruh}; \citet{gong2024unveiling}; \citet{tirtayasa2020effect} (Pengaruh positif signifikan; kesenangan afektif melumpuhkan rasionalitas belanja). & \citet{zheng2019impact} (Pengaruh tidak signifikan; tertahan batasan anggaran dan evaluasi fungsional). & Perbedaan elastisitas anggaran dan dominasi orientasi utiliter vs afektif konsumen. \\
\addlinespace[4pt]
2 & $X_2 \rightarrow Y$ (\emph{Desire for Completeness} ke \emph{Impulsive Buying}) & \citet{gao2014completing}; \citet{barasz2017pseudo}; \citet{tan2024ketidakpastian}; \citet{dewi2024understanding} (Pengaruh positif signifikan; ketegangan psikologis set memicu akselerasi transaksi). & \citet{long2000consuming}; \citet{spero2004approach} (Pengaruh tidak signifikan; kolektor matang menolak produk acak dan memilih kartu satuan di pasar sekunder). & Perbedaan tingkat kematangan kolektor (\emph{collector maturity}) dan kalkulasi probabilitas kemasan acak. \\
\addlinespace[4pt]
3 & $X_3 \rightarrow Y$ (\emph{Speculative Motive} ke \emph{Impulsive Buying}) & \citet{shiller2000irrational}; \citet{baur2018bitcoin}; \citet{aryadi2024personal}; \citet{colline2024biases} (Pengaruh positif signifikan; ekspektasi \emph{capital gain} dan optimisme memicu spekulasi spontan). & \citet{barber2008all}; \citet{fama1970efficient} (Pengaruh tidak signifikan; motif spekulasi diimbangi kesadaran risiko penurunan modal). & Asimetri informasi pasar dan bias ilusi kendali keuntungan vs evaluasi risiko kerugian modal. \\
\addlinespace[4pt]
4 & $M \rightarrow Y$ (\emph{Self-Control} ke \emph{Impulsive Buying}) & \citet{baumeister2002yield}; \citet{tangney2004high}; \citet{vohs2007spent}; \citet{sultan2012building} (Pengaruh negatif signifikan; regulasi diri disiplin menunda kepuasan belanja). & \citet{hirschman1982hedonic}; \citet{stern1962significance} (Pengaruh lemah; stimulus sensori mendadak membypass kontrol diri sadar). & Keterbatasan kapasitas energi kognitif (\emph{ego depletion}) saat menghadapi stimulus lingkungan toko yang intens. \\
\addlinespace[4pt]
5 & $X_1 \cdot M \rightarrow Y$ (Moderasi $M$ pada $X_1 \rightarrow Y$) & \citet{sultan2012building}; \citet{apidana2022peran} (Memperlemah pengaruh; kontrol diri efektif menjadi peredam belanja hedonis). & \citet{prasetio2021hedonic}; \citet{zheng2019impact} (Tidak mampu memoderasi; kontrol diri gagal menahan luapan emosional yang ekstrem). & Ambang batas intensitas stimulus hedonis yang melampaui kapasitas kontrol volisional. \\
\addlinespace[4pt]
6 & $X_2 \cdot M \rightarrow Y$ (Moderasi $M$ pada $X_2 \rightarrow Y$) & \citet{lienardy2024role}; \citet{artadita2024how} (Memperlemah pengaruh; kontrol diri menahan godaan belanja koleksi berlebihan). & \citet{belk1995collecting}; \citet{barasz2017pseudo} (Tidak mampu memoderasi; hasrat kelengkapan menjadi obsesi kuasi-kompulsif). & Tingkat keterikatan emosional kolektor (\emph{involvement}); hobi kasual vs fanatisme koleksi mendalam. \\
\addlinespace[4pt]
7 & $X_3 \cdot M \rightarrow Y$ (Moderasi $M$ pada $X_3 \rightarrow Y$) & \citet{katauke2023financial}; \citet{colline2024biases} (Memperlemah pengaruh; disiplin finansial meredam spekulasi jangka pendek). & \citet{shiller2000irrational}; \citet{aryadi2024personal} (Tidak mampu memoderasi; ilusi pasar sekunder menumbangkan kontrol diri). & Tekanan sosial komunitas, bias \emph{herding}, dan ketakutan tertinggal momentum keuntungan (\emph{FOMO}). \\
\end{longtable}
\vspace{-0.3cm}
\begin{flushleft}
...
\begin{enumerate}
  ...
  \item Apakah \emph{Self-Control} memoderasi pengaruh \emph{Hedonic Motivation} terhadap \emph{Impulsive Buying} \emph{booster pack} kartu Pok\'emon TCG?
  \item Apakah \emph{Self-Control} memoderasi pengaruh \emph{Desire for Completeness} terhadap \emph{Impulsive Buying} \emph{booster pack} kartu Pok\'emon TCG?
  \item Apakah \emph{Self-Control} memoderasi pengaruh \emph{Speculative Motive} terhadap \emph{Impulsive Buying} \emph{booster pack} kartu Pok\'emon TCG?
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Untuk menganalisis dan membuktikan secara empiris peran moderasi \emph{Self-Control} pada pengaruh \emph{Hedonic Motivation} terhadap \emph{Impulsive Buying} \emph{booster pack} kartu Pok\'emon TCG.
  \item Untuk menganalisis dan membuktikan secara empiris peran moderasi \emph{Self-Control} pada pengaruh \emph{Desire for Completeness} terhadap \emph{Impulsive Buying} \emph{booster pack} kartu Pok\'emon TCG.
  \item Untuk menganalisis dan membuktikan secara empiris peran moderasi \emph{Self-Control} pada pengaruh \emph{Speculative Motive} terhadap \emph{Impulsive Buying} \emph{booster pack} kartu Pok\'emon TCG.
\end{enumerate}
...
1 & \citet{pranggabayu2022pengaruh} & Pengaruh \emph{Hedonic Shopping Motivation} dan \emph{Store Atmosphere} terhadap \emph{Impulsive Buying} & X1: \emph{Hedonic shopping motivation}, X2: \emph{Store atmosphere}; Y: \emph{Impulsive buying}; Regresi linear berganda (100 pengunjung) & Motivasi belanja hedonis berpengaruh positif dan signifikan terhadap \emph{impulsive buying}; kesenangan berbelanja menurunkan deliberasi rasional konsumen. \\
\addlinespace[4pt]
...
\addlinespace[4pt]
3 & \citet{lienardy2024role} & \emph{The Role of Self-Control in Moderating the Influence of Shopping Lifestyle and Hedonistic Behavior on Impulsive Buying} & X1: \emph{Shopping lifestyle}, X2: \emph{Hedonistic behavior}; Y: \emph{Impulsive buying}; Mod: \emph{Self-control}; MRA (160 responden) & Perilaku hedonis berpengaruh positif signifikan terhadap pembelian impulsif; kontrol diri terbukti memoderasi dan memperlemah pengaruh perilaku hedonis terhadap \emph{impulsive buying}. \\
\addlinespace[4pt]
...
\addlinespace[4pt]
5 & \citet{tan2024ketidakpastian} & Ketidakpastian \emph{Blind Box} dan Perilaku Pembelian Impulsif: Peran Nilai Fungsional, Emosional, dan Sosial & X: Ketidakpastian \emph{blind box}, Nilai konsumsi; Y: Pembelian impulsif; Kuantitatif survei di Indonesia & Ketidakpastian isi kemasan acak membangkitkan nilai emosional yang kuat, secara signifikan mendorong perilaku pembelian impulsif konsumen di Indonesia. \\
\addlinespace[4pt]
6 & \citet{dewi2024understanding} & \emph{Understanding Impulse Buying Behavior: The Case of Blind Box Purchases in Indonesia} & X1: \emph{Perceived scarcity}, X2: \emph{Perceived uncertainty}; Med: FOMO; Y: \emph{Impulse buying}; PLS-SEM (211 Gen Z Indonesia) & Persepsi kelangkaan item dan ketidakpastian memicu FOMO dan hasrat memiliki set koleksi utuh, yang secara langsung dan signifikan memicu \emph{impulse buying} pada Generasi Z di Indonesia. \\
\addlinespace[4pt]
...
\addlinespace[4pt]
8 & \citet{colline2024biases} & \emph{Biases in Indonesian Stock Investor Behavior} & X: Bias perilaku kognitif (\emph{overconfidence, herding}); Y: Keputusan investasi; Kuantitatif survei di Indonesia & Membuktikan kuatnya pengaruh bias optimisme berlebih (\emph{overconfidence}) dan perilaku ikut-ikutan (\emph{herding}) pada pengambilan keputusan finansial investor muda di Indonesia. \\
\addlinespace[4pt]
9 & \citet{artadita2024how} & \emph{How Does Self-Control Moderate Shopping Enjoyment and Impulse Buying Among Generation Z Online Gamers?} & X: Kenikmatan belanja (\emph{shopping enjoyment}); Y: \emph{Impulse buying}; Mod: \emph{Self-control}; MRA (220 Gen Z Gamers) & Kenikmatan berbelanja komoditas game berpengaruh positif kuat terhadap pembelian impulsif; kontrol diri kognitif memegang peranan esensial dalam menahan dorongan belanja spontan. \\
\addlinespace[4pt]
10 & \citet{katauke2023financial} & \emph{Financial Literacy and Impulsivity: Evidence from Japan} & X: Literasi \& disiplin finansial; Y: \emph{Impulsivity (hyperbolic discounting)}; Instrumental variables \& regresi & Kapasitas regulasi diri dan kontrol finansial secara signifikan menekan impulsivitas belanja dan mencegah keputusan konsumtif yang merugikan. \\
\end{longtable}
\vspace{-0.3cm}
\begin{flushleft}
...
\begin{enumerate}
  ...
  \end{itemize}
  \item \textbf{Pernah Membeli \emph{Booster Pack} Resmi Pok\'emon TCG Fisik Minimal 1 Kali dalam Kurun Waktu 6 Bulan Terakhir (Maksimal 12 Bulan Terakhir):}
  \begin{itemize}
...
\begin{itemize}
  \item \textbf{Uji Validitas Butir:} Menggunakan teknik korelasi butir-total (\emph{Pearson Product Moment / corrected item-total correlation}) terhadap skor komposit konstruk yang dituju. Suatu butir pernyataan kuesioner dinyatakan valid jika nilai $r_{\text{hitung}} > r_{\text{tabel}}$ pada tingkat signifikansi $\alpha = 0,05$ untuk uji dua sisi.
...
Evaluasi kecocokan model dilakukan dengan memeriksa nilai \emph{Adjusted} $R^2$ pada Model 1 dan Model 2. Kontribusi penjelas murni dari blok variabel moderasi dibuktikan melalui nilai peningkatan koefisien determinasi ($\Delta R^2 = R^2_{\text{Model 2}} - R^2_{\text{Model 1}}$) yang diuji signifikansinya menggunakan statistik $F_{\text{change}}$ pada taraf signifikansi $p < 0,05$ (Persamaan~\ref{eq:f_change}).
