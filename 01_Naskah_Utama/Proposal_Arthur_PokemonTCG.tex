...
\begin{enumerate}
  ...
  \begin{itemize}
    \item \emph{Temuan A (Positif dan Signifikan):} Studi kuantitatif eksperimental oleh \citet{gao2014completing}, \citet{barasz2017pseudo}, \citet{tan2024ketidakpastian}, dan \citet{dewi2024understanding} membuktikan bahwa hasrat melengkapi himpunan (\emph{The Completing the Set Effect}) dan persepsi ketidaklengkapan memicu ketegangan psikologis (\emph{Zeigarnik Effect}) yang secara signifikan mempercepat transaksi pembelian spontan demi menutup celah kekosongan koleksi.
