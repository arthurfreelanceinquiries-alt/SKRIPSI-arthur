...
Sebagaimana ditunjukkan pada Gambar~\ref{fig:media_franchise_ranking}, Pok\'emon menempati posisi puncak sebagai waralaba media nomor satu di dunia dengan total pendapatan melampaui US\$ 100,0 miliar \citep{statista2024pokemon}. Nilai ini mengungguli waralaba raksasa global lainnya seperti \emph{Hello Kitty} (US\$ 84,5 miliar), \emph{Winnie the Pooh} (US\$ 75,0 miliar), \emph{Mickey Mouse \& Friends} (US\$ 70,0 miliar), \emph{Star Wars} (US\$ 68,7 miliar), maupun \emph{Marvel Cinematic Universe} (US\$ 35,3 miliar). Bukti empiris ini mengonfirmasi bahwa Pok\'emon bukan sekadar hiburan musiman anak-anak, melainkan entitas komersial raksasa dengan basis perputaran kapital lintas generasi yang sangat kokoh.
...
Sebagaimana disajikan pada Gambar~\ref{fig:pricecharting_disparity}, kartu berkondisi sempurna (\emph{PSA 10 Gem Mint}) mengalami apresiasi nilai pasar sekunder yang spektakuler, berkisar antara 2,0 kali lipat pada kartu langka utama (\emph{Charizard VMAX \#SV107}) hingga menembus 23,7 kali lipat (\emph{Kyogre \#21}) dan 26,0 kali lipat (\emph{Reshiram \#17}) dibandingkan kondisi kartu mentah tanpa sertifikasi \citep{pricecharting2024}. Fenomena disparitas harga yang masif ini memperkuat ekspektasi keuntungan finansial dan membuktikan secara empiris bekerjanya motif spekulasi finansial (\emph{Speculative Motive} / $X_3$) di mana konsumen terdorong membeli \emph{booster pack} acak demi mengejar potensi keuntungan arbitrase grading (\emph{grading arbitrage}).
