...
def generate_catalog():
    ...
    lines.append("|---|---|---|---|")
    lines.append("| **$X_1$** | Blind-Box Product Characteristics | Gong et al. (2024), Katauke et al. (2023), Azizah & Fauzi (2025), Dewi et al. (2026) | Mehrabian & Russell (1974) S-O-R Framework |")
    lines.append("| **$X_2$** | Desire for Completeness | Dewi et al. (2026) | Barasz et al. (2017) Pseudo-Set Framing, Gao et al. (2014) |")
    lines.append("| **$X_3$** | Speculative Motive | Aryadi & Lingga (2024), Colline (2024) | Shiller (2000) Irrational Exuberance, Baur et al. (2018) |")
    lines.append("| **$Z$** | Self-Control (Moderasi) | Artadita & Firmialy (2024), Lienardy & Panasea (2026), Apidana & Kholifah (2022), Colline (2024) | Tangney et al. (2004) BSCS, Baumeister (2002), Vohs & Faber (2007) |")
    lines.append("| **$Y$** | Impulsive Buying | Gong et al. (2024), Katauke et al. (2023), Dewi et al. (2026), Pranggabayu & Andjarwati (2022) | Rook (1987), Verplanken & Herabadi (2001) IBTS, Amos et al. (2014) |")
    lines.append("")
    lines.append("---")
