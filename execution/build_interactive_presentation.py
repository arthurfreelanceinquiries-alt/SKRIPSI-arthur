...
=================================
Eksekutor deterministik untuk menghasilkan aplikasi web presentasi interaktif
dan modul belajar mandiri (Study Suite) proposal skripsi S1 Manajemen Keuangan FEB UKRIDA.

Menghasilkan:
1. 02_Persiapan_Sidang/presentasi_interaktif/style.css
2. 02_Persiapan_Sidang/presentasi_interaktif/app.js
3. 02_Persiapan_Sidang/presentasi_interaktif/index.html
4. 02_Persiapan_Sidang/PRESENTASI_PANDUAN_BELAJAR.html (standalone bundle all-in-one)
"""
...
OUTPUT_DIR = os.path.join(BASE_DIR, "02_Persiapan_Sidang", "presentasi_interaktif")
STANDALONE_FILE = os.path.join(BASE_DIR, "02_Persiapan_Sidang", "PRESENTASI_PANDUAN_BELAJAR.html")

os.makedirs(OUTPUT_DIR, exist_ok=True)

# 1. DATA KONTEN KANONIS
SLIDES_DATA = [
    {
        "id": 1,
        "tag": "COVER & IDENTITAS",
        "title": "Proposal Penelitian Skripsi",
        "subtitle": "S1 Manajemen Keuangan — Fakultas Ekonomi dan Bisnis UKRIDA",
        "content_type": "cover",
        "speaker_notes": "Buka presentasi dengan salam formal kepada Dosen Pembimbing/Penguji. Sebutkan judul dengan tegas dan artikulatif. Tekankan konsentrasi Manajemen Keuangan dan fokus pada objek kartu fisik Pokémon TCG."
    },
    {
        "id": 2,
        "tag": "LATAR BELAKANG & FENOMENA",
        "title": "Fenomena Lapangan & Tiga Anomali Pasar",
        "subtitle": "Transformasi Produk Hobi Menjadi Komoditas Spekulatif Likuid",
        "content_type": "fenomena",
        "speaker_notes": "Jelaskan bahwa kartu Pokémon TCG bukan lagi sekadar mainan anak-anak. Sebutkan 3 anomali: penetrasi kasir ritel modern, mekanisme blind-pack mystery, dan disparitas harga SAR ekstrem (Rp25rb vs Rp3jt)."
    },
    {
        "id": 3,
        "tag": "JUSTIFIKASI OBJEK",
        "title": "Mengapa Memilih Kartu Koleksi (TCG)?",
        "subtitle": "Konvergensi Nilai Emosional, Hasrat Kelengkapan, dan Likuiditas Pasar Fisik",
        "content_type": "justifikasi_tcg",
        "speaker_notes": "Antisipasi pertanyaan dosen: kenapa TCG bukan video game? Jawab: video game dibeli 1x (one-off), sedangkan TCG dibeli berulang (repetitive purchase) dengan ketidakpastian tinggi dan likuiditas pasar sekunder 64,8 miliar kartu."
    },
    {
        "id": 4,
        "tag": "INDUSTRI GRADING",
        "title": "Lembaga Sertifikasi Grading & Arbitrase",
        "subtitle": "Mekanisme PSA, BGS, CGC dalam Menetapkan Likuiditas & Nilai Investasi",
        "content_type": "grading_arbitrage",
        "speaker_notes": "Jelaskan peran PSA/BGS/CGC: skala 1-10 Gem Mint, tamper-evident slab, population report, dan fenomena grading arbitrage yang memicu speculative motive."
    },
    {
        "id": 5,
        "tag": "OPERASIONALISASI VARIABEL",
        "title": "Bedah 5 Variabel Penelitian (3X, 1Y, 1M)",
        "subtitle": "Definisi Konseptual, Dimensi, Indikator, dan Adaptasi Skala Baku",
        "content_type": "variabel_table",
        "speaker_notes": "Tunjukkan ketelitian metodologis: X1 (Hedonic - Arnold & Reynolds), X2 (Desire for Completeness - Gao et al. 2014 & Zeigarnik), X3 (Speculative - Keynes & Shiller), Y (Impulsive - Rook & Verplanken), M (Self-Control - Tangney et al. & Baumeister)."
    },
    {
        "id": 6,
        "tag": "RERANGKA KONSEPTUAL",
        "title": "Model Penelitian & Persamaan MRA",
        "subtitle": "Pengaruh Langsung (H1–H3) dan Efek Moderasi Memperlemah (H4–H6)",
        "content_type": "mra_framework",
        "speaker_notes": "Paparkan diagram alur. Jelaskan perbedaan Model 1 (Main Effects) dan Model 2 (Interaction Terms). Tekankan bahwa hipotesis moderasi dirumuskan memperlemah (-)."
    },
    {
        "id": 7,
        "tag": "LANDASAN TEORETIS",
        "title": "Grand Theory & Supporting Theories",
        "subtitle": "Behavioral Finance sebagai Payung Utama dan 3 Teori Pendukung",
        "content_type": "teori_struktur",
        "speaker_notes": "Tegaskan Grand Theory: Behavioral Finance (Simon Bounded Rationality, Kahneman-Tversky Prospect Theory, Shiller Irrational Exuberance, Thaler-Shefrin Planner-Doer). Teori pendukung: S-O-R, Completing the Set Effect, Self-Regulation Theory."
    },
    {
        "id": 8,
        "tag": "TELAAH EMPIRIS",
        "title": "Matriks 10 Penelitian Terdahulu (2021–2025)",
        "subtitle": "Pemetaan Anteseden Impulsive Buying & Posisi Kebaruan (Novelty)",
        "content_type": "jurnal_matrix",
        "speaker_notes": "Tunjukkan 10 jurnal rujukan terbaru termasuk riset Dosen FEB UKRIDA (Colline, 2024), jurnal Scopus Q1 (Gong et al., 2024 Heliyon; Katauke et al., 2023), dan riset komunitas TCG Jakarta (Aryadi & Lingga, 2024)."
    },
    {
        "id": 9,
        "tag": "HIPOTESIS PENELITIAN",
        "title": "Logika Kausalitas & 4-Tier Pembuktian Hipotesis",
        "subtitle": "Struktur Baku: Teori → Empiris → Objek Pokémon TCG → Rumusan Hipotesis",
        "content_type": "hipotesis_tiers",
        "speaker_notes": "Jelaskan struktur 4-tier: dosen menuntut agar setiap hipotesis dikaitkan secara eksplisit dengan objek fisik kartu Pokémon TCG. H1-H3 berpengaruh positif (+), H4-H6 memoderasi memperlemah (-)."
    },
    {
        "id": 10,
        "tag": "METODOLOGI PENELITIAN",
        "title": "Desain Penelitian, Sampling, & Mean-Centering",
        "subtitle": "Kuantitatif Asosiatif, Purposive Sampling (N=120-150), & Regresi OLS SPSS",
        "content_type": "metodologi_mra",
        "speaker_notes": "Pertahankan formula Green (1991): N >= 50 + 8k = 106; target 120-150 responden (Cohen power 0.80). Jelaskan prosedur mean-centering untuk eliminasi multikolinearitas struktural, dan alasan tidak perlunya uji autokorelasi."
    },
    {
        "id": 11,
        "tag": "SIMULASI SIDANG",
    ...
    {
        "id": 12,
        "tag": "PENUTUP & ACTION PLAN",
        "title": "Cheat Sheet Kilat & Checklist Menjelang Sidang",
        "subtitle": "Rangkuman 1 Halaman: Logika Kuat, Mental Tenang, Penyampaian Percaya Diri",
        "content_type": "penutup_cheatsheet",
        "speaker_notes": "Tutup dengan ringkasan 1 halaman. Sampaikan komitmen penyelesaian bab demi bab sesuai Buku Pedoman FEB UKRIDA."
    }
]

FLASHCARDS_DATA = [
    {"id": 1, "cat": "var", "color": "blue", "title": "Impulsive Buying (Y)", "term": "Impulsive Buying", "author": "Rook (1987); Verplanken & Herabadi (2001)", "desc": "Pembelian mendadak, spontan, dan tanpa perencanaan anggaran sebelumnya yang didorong oleh stimulus lingkungan dan desakan emosional sesaat.", "hint": "Variabel Dependen (Y) — Dimensi Kognitif & Afektif"},
    {"id": 2, "cat": "var", "color": "blue", "title": "Hedonic Motivation (X1)", "term": "Hedonic Motivation", "author": "Arnold & Reynolds (2003); Babin et al. (1994)", "desc": "Dorongan berbelanja demi kesenangan emosional, sensasi petualangan (*adventure*), letupan kegembiraan (*gratification*), dan pelarian stres.", "hint": "Variabel Independen 1 (X1) — Sensasi merobek pack"},
    {"id": 3, "cat": "var", "color": "blue", "title": "Desire for Completeness (X2)", "term": "Desire for Completeness", "author": "Gao, Huang, & Simonson (2014); Barasz et al. (2017)", "desc": "Dorongan psikologis untuk menuntaskan himpunan koleksi yang belum lengkap, dipicu oleh ketegangan kognitif melihat celah slot kosong pada binder.", "hint": "Variabel Independen 2 (X2) — The Completing the Set Effect"},
    {"id": 4, "cat": "var", "color": "blue", "title": "Speculative Motive (X3)", "term": "Speculative Motive", "author": "Keynes (1936); Shiller (2000); Baur et al. (2018)", "desc": "Tindakan mengakuisisi aset dengan ekspektasi menjualnya kembali di pasar sekunder untuk meraih keuntungan modal (*capital gain*) dari kenaikan harga.", "hint": "Variabel Independen 3 (X3) — Ekspektasi cuan kartu langka"},
    {"id": 5, "cat": "var", "color": "blue", "title": "Self-Control (M)", "term": "Self-Control (Kontrol Diri)", "author": "Tangney et al. (2004); Baumeister (2002); Sultan et al. (2012)", "desc": "Kapasitas volisional individu untuk menolak godaan belanja spontan, menunda kepuasan (*delay of gratification*), dan menegakkan batas anggaran.", "hint": "Variabel Moderasi (M) — Rem volisional / Planner-Doer"},
    {"id": 6, "cat": "theory", "color": "green", "title": "Grand Theory", "term": "Behavioral Finance", "author": "Herbert Simon (1955); Kahneman & Tversky (1979); Shiller (2000)", "desc": "Paradigma keuangan yang mengkaji bias psikologis dan batasan kognitif (*bounded rationality*) manusia yang menyebabkan anomali keputusan pasar tidak rasional.", "hint": "Grand Theory Skripsi — Menolak Efficient Market Hypothesis"},
    {"id": 7, "cat": "theory", "color": "green", "title": "Planner-Doer Model", "term": "Dual-System Planner-Doer", "author": "Thaler & Shefrin (1981)", "desc": "Model pertarungan psikologis antara 'Doer' (sisi impulsif pencari kenikmatan jangka pendek) dan 'Planner' (sisi rasional perencana jangka panjang).", "hint": "Landasan peran Self-Control sebagai moderator"},
    {"id": 8, "cat": "theory", "color": "green", "title": "S-O-R Framework", "term": "Stimulus-Organism-Response", "author": "Mehrabian & Russell (1974)", "desc": "Stimulus lingkungan ritel (S) mempengaruhi kondisi internal emosi/kognisi individu (O) yang akhirnya memicu respons tindakan konsumsi (R).", "hint": "Supporting Theory 1 — Pajangan kasir -> Emosi -> Beli"},
    {"id": 9, "cat": "theory", "color": "green", "title": "Zeigarnik Effect", "term": "Zeigarnik Effect", "author": "Bluma Zeigarnik (1927)", "desc": "Kecenderungan kognitif manusia untuk lebih mengingat dan merasa terganggu oleh tugas yang belum tuntas dibanding tugas yang sudah selesai.", "hint": "Akar psikologi hasrat menuntaskan nomor binder"},
    {"id": 10, "cat": "theory", "color": "green", "title": "Completing the Set Effect", "term": "The 'Completing the Set' Effect", "author": "Gao, Huang, & Simonson (2014, JMR)", "desc": "Fenomena di mana motivasi akuisisi konsumen melonjak drastis secara non-linier ketika himpunan koleksi mendekati batas kelengkapan penuh.", "hint": "Istilah ilmiah baku rujukan jurnal pemasaran Q1"},
    {"id": 11, "cat": "theory", "color": "green", "title": "Self-Regulation Theory", "term": "Self-Regulation Theory & Ego Depletion", "author": "Baumeister (2002); Vohs & Faber (2007)", "desc": "Kontrol diri dipandang sebagai sumber daya energi mental terbatas (*ego depletion*). Ketika energi ini habis, manusia rentan melakukan belanja impulsif.", "hint": "Supporting Theory 3 — Kekuatan rem volisional"},
    {"id": 12, "cat": "theory", "color": "green", "title": "Prospect Theory", "term": "Prospect Theory & Lottery Effect", "author": "Kahneman & Tversky (1979)", "desc": "Kecenderungan manusia melebih-lebihkan probabilitas kecil untuk meraih keuntungan sangat besar, persis seperti harapan menarik kartu SAR dari booster pack.", "hint": "Bias optimisme berlebihan di balik pembelian pack"},
    {"id": 13, "cat": "tcg", "color": "yellow", "title": "Trading Card Game", "term": "Pokémon TCG Fisik", "author": "Nintendo / Creatures Inc. (1996)", "desc": "Permainan kartu koleksi strategis fisik yang telah mencetak lebih dari 64,8 miliar lembar kartu di seluruh dunia dan memiliki pasar sekunder sangat aktif.", "hint": "Objek Penelitian Skripsi"},
    {"id": 14, "cat": "tcg", "color": "yellow", "title": "Blind-Pack Mystery", "term": "Booster Pack & Blind-Pack", "author": "Mekanisme Produk", "desc": "Kemasan foil tertutup kedap cahaya berisi kartu acak (biasanya 5–10 lembar) di mana pembeli tidak mengetahui isinya sebelum bungkus dirobek.", "hint": "Pemicu sensasi gacha & rasa penasaran"},
    {"id": 15, "cat": "tcg", "color": "yellow", "title": "SAR Card", "term": "Special Illustration Rare (SAR)", "author": "Kategori Kelangkaan", "desc": "Tingkat kelangkaan kartu tertinggi dengan gambar ilustrasi penuh (*full-art*). Memiliki pull rate sangat kecil (<1-3%) dan harga termahal di pasar sekunder.", "hint": "Target utama kolektor & spekulan (Rp500rb - Rp3jt+)"},
    {"id": 16, "cat": "tcg", "color": "yellow", "title": "Sertifikasi Grading", "term": "Lembaga Grading (PSA, BGS, CGC)", "author": "Third-Party Authentication", "desc": "Lembaga independen terakreditasi internasional yang memeriksa keaslian dan kondisi fisik kartu secara objektif dengan skala 1 (Poor) sampai 10 (Gem Mint).", "hint": "Pemberi legitimasi likuiditas aset kartu fisik"},
    {"id": 17, "cat": "tcg", "color": "yellow", "title": "Tamper-Evident Slab", "term": "Slab & Population Report", "author": "Standar Keamanan Grading", "desc": "Cangkang plastik sonik kedap udara berlabel barcode/QR yang mengunci kartu secara permanen, didukung basis data populasi (*Pop Report*) tingkat kelangkaan.", "hint": "Kemasan pelindung kartu bersertifikat grade 10"},
    {"id": 18, "cat": "tcg", "color": "yellow", "title": "Grading Arbitrage", "term": "Arbitrase Grading (Grading Arbitrage)", "author": "Mekanisme Keuangan Pasar", "desc": "Strategi membeli kartu mentah seharga ratusan ribu rupiah, mengirimnya untuk di-grading, dan menjualnya kembali di harga jutaan rupiah jika meraih PSA 10.", "hint": "Pemicu utama Speculative Motive di komunitas TCG"},
    {"id": 19, "cat": "stat", "color": "red", "title": "Teknik Analisis", "term": "Moderated Regression Analysis (MRA)", "author": "Aiken & West (1991); Ghozali (2018)", "desc": "Aplikasi khusus regresi linier berganda yang menyertakan istilah perkalian/interaksi (X·M) untuk menguji apakah moderator memperkuat atau memperlemah hubungan.", "hint": "Metode Statistik Utama Penelitian"},
    {"id": 20, "cat": "stat", "color": "red", "title": "Uji Asumsi Multikol", "term": "Prosedur Mean-Centering", "author": "Aiken & West (1991); Cohen et al. (2003)", "desc": "Mengurangi nilai variabel dengan nilai rata-ratanya (X* = X - X̄) sebelum dikalikan untuk mengeliminasi multikolinearitas struktural tanpa mengubah signifikansi.", "hint": "Solusi ilmiah jika VIF interaksi melonjak tinggi"},
    {"id": 21, "cat": "stat", "color": "red", "title": "Teknik Sampling", "term": "Purposive Sampling", "author": "Sekaran & Bougie (2016); Sugiyono (2019)", "desc": "Teknik penentuan sampel non-acak dengan pertimbangan kriteria inklusi tertentu agar responden memiliki pemahaman dan pengalaman relevan terhadap objek.", "hint": "Kriteria: WNI >=17 thn, pernah beli pack resmi 6-12 bln"},
    {"id": 22, "cat": "stat", "color": "red", "title": "Formula Sampel", "term": "Kaidah Green (1991) & Cohen (1988)", "author": "Green (1991); Cohen (1988)", "desc": "Formula N >= 50 + 8k (k=7 -> N >= 106). Target penelitian: 120-150 responden untuk menjamin statistical power >= 0.80 pada medium effect size f2=0.15.", "hint": "Justifikasi jumlah kecukupan sampel S1"},
...
DEFENSE_QUESTIONS = [
    {
        "id": 1,
        "type": "bimbingan",
        "badge": "Revisi Kunci 9 Sep",
        "question": "Mengapa Anda mengubah variabel moderasi dari Literasi Keuangan menjadi Self-Control?",
        "keywords": ["Knowledge-to-behavior gap", "Rem volisional", "Planner-Doer Model", "Thaler & Shefrin (1981)", "Sultan et al. (2012)"],
        "answer": "Terima kasih atas pertanyaannya. Perubahan ini dilakukan berdasarkan hasil telaah literatur dan arahan Ibu Pembimbing pada bimbingan 9 September 2026. Pertama, literasi keuangan berlandaskan domain kognitif (pengetahuan), di mana studi empiris (Fernandes et al., 2014) kerap menemukan 'knowledge-to-behavior gap' — orang yang paham teori keuangan belum tentu mampu menahan diri saat berbelanja. Sebaliknya, Self-Control (Kontrol Diri) merupakan kapasitas volisional eksekutif yang bekerja langsung sebagai 'rem perilaku'. Dalam teori Planner-Doer (Thaler & Shefrin, 1981) dan studi empiris Sultan et al. (2012), kontrol diri secara konsisten terbukti memperlemah dorongan belanja impulsif."
    },
    {
        "id": 2,
        "type": "bimbingan",
        "badge": "Istilah Ilmiah Baku",
        "question": "Mengapa Anda mengganti istilah 'Need for Completion' menjadi 'Desire for Completeness'?",
        "keywords": ["Gao, Huang, & Simonson (2014)", "Journal of Marketing Research", "The Completing the Set Effect", "Barasz et al. (2017)", "Zeigarnik Effect (1927)"],
        "answer": "Istilah 'Need for Completion' bersifat informal dan belum dibakukan dalam konteks perilaku konsumen. Dalam literatur pemasaran terkemuka (Journal of Marketing Research), konstruk ini telah diformalkan oleh Gao, Huang, & Simonson (2014) sebagai 'The Completing the Set Effect' dan oleh Barasz et al. (2017) sebagai 'Desire for Completeness'. Landasan psikologinya berakar kokoh pada Zeigarnik Effect (1927) mengenai ketegangan kognitif akibat tugas yang belum selesai. Penggunaan istilah Desire for Completeness memberikan rujukan jurnal internasional Q1 yang sangat kredibel."
    },
    {
        "id": 3,
        "type": "bimbingan",
        "badge": "Konsentrasi Keuangan",
        "question": "Mengapa Grand Theory yang digunakan adalah Behavioral Finance, bukan teori pemasaran murni?",
        "keywords": ["Manajemen Keuangan", "Aset alternatif spekulatif", "Bounded Rationality", "Prospect Theory & Lottery Effect", "Irrational Exuberance"],
        "answer": "Penelitian ini diajukan pada Program Studi S1 Manajemen Konsentrasi Manajemen Keuangan. Objek kartu Pokémon TCG saat ini telah bertransformasi menjadi aset alternatif bernilai spekulatif dengan pasar sekunder yang sangat likuid. Grand Theory Behavioral Finance (Simon, 1955; Kahneman & Tversky, 1979; Shiller, 2000; Thaler & Shefrin, 1981) secara tepat membedah anomali keputusan keuangan konsumen muda yang irasional: adanya ilusi probabilitas (lottery effect), bias optimisme menarik kartu mahal bernilai PSA 10, serta konflik antara kesenangan sesaat (Doer) dan perencanaan anggaran jangka panjang (Planner)."
    },
    {
        "id": 4,
        "type": "bimbingan",
        "badge": "Struktur Naskah",
        "question": "Mengapa di BAB II variabel Dependen (Y) dibahas terlebih dahulu sebelum variabel Independen (X)?",
        "keywords": ["Masalah inti penelitian", "Alur logis", "Standar telaah pustaka", "Fenomena yang dipengaruhi"],
        "answer": "Sesuai kaidah penulisan ilmiah yang logis dan arahan Dosen Pembimbing, variabel dependen (Y - Impulsive Buying) merupakan masalah utama atau fenomena inti yang ingin diselesaikan dalam penelitian ini. Dengan membedah definisi, dimensi, dan batasan operasional Y terlebih dahulu, kita membangun standar pemahaman yang jelas tentang apa yang sedang dipengaruhi, sebelum kemudian menganalisis faktor-faktor pemicunya (X1, X2, X3) dan variabel pemoderasinya (M)."
    },
    {
        "id": 5,
        "type": "bimbingan",
        "badge": "Kaitan Objek Fisik",
        "question": "Bagaimana kaitan sertifikasi grading (PSA, BGS, CGC) dengan variabel Speculative Motive?",
        "keywords": ["Skala 1-10 Gem Mint", "Tamper-evident slab", "Population report", "Grading arbitrage", "Disparitas harga modal vs jual"],
        "answer": "Lembaga grading profesional seperti PSA menilai keaslian dan kondisi fisik kartu pada skala 1-10 (Gem Mint 10) lalu menyegelnya dalam tamper-evident slab. Kartu bersertifikat PSA 10 memiliki harga pasar puluhan kali lipat dari kartu mentah karena didukung population report resmi yang membuktikan kelangkaannya. Disparitas harga inilah yang menciptakan fenomena grading arbitrage — pembeli memborong booster pack dengan spekulasi memperoleh kartu berkondisi sempurna yang dapat di-grade dan dijual kembali demi capital gain."
    },
    {
        "id": 6,
        "type": "bimbingan",
        "badge": "Hipotesis Moderasi",
        "question": "Mengapa hipotesis moderasi (H4, H5, H6) dirumuskan memperlemah (-), bukan memperkuat?",
        "keywords": ["Self-Regulation Theory", "Planner-Doer Model", "Rem volisional", "Delay of gratification", "Meredam dampak X terhadap Y"],
        "answer": "Karena variabel moderasi yang digunakan adalah Self-Control (Kontrol Diri). Menurut Self-Regulation Theory (Baumeister, 2002) dan model Planner-Doer (Thaler & Shefrin, 1981), kontrol diri adalah rem volisional. Ketika kontrol diri konsumen tinggi, mereka memiliki kapasitas untuk menunda kepuasan (delay of gratification) dan menahan dorongan belanja spontan, sehingga efek rangsangan emosional (X1), hasrat kelengkapan (X2), dan motif spekulasi (X3) terhadap Impulsive Buying (Y) berhasil diredam atau diperlemah."
    },
    {
        "id": 7,
        "type": "jebakan",
    ...
    },
    {
        ...
        "type": "jebakan",
        "badge": "Jebakan Penguji ⭐⭐⭐⭐⭐",
        "question": "Speculative motive dicetuskan Keynes (1936) untuk pasar uang/obligasi. Bukankah menggunakannya untuk kartu mainan adalah peregangan teori yang berlebihan?",
        "keywords": ["Esensi capital gain", "Robert Shiller (2000) Irrational Exuberance", "Baur et al. (2018) Alternative Assets", "Pasar sekunder likuid", "Koleksi sebagai instrumen investasi"],
        "answer": "Memang benar Keynes awalnya membahas motif spekulasi dalam konteks preferensi likuiditas pasar uang. Namun esensi dari speculative motive — yaitu mengakuisisi aset dengan ekspektasi memperoleh keuntungan modal (capital gain) dari apresiasi harga di masa depan — bersifat universal. Robert Shiller (2000) memperluasnya ke berbagai kelas aset dalam Irrational Exuberance, dan Baur et al. (2018) secara eksplisit mengkaji barang koleksi (collectibles) sebagai alternative tangible assets. Kartu Pokémon TCG saat ini memiliki pasar sekunder terorganisir, standar sertifikasi grading (PSA 10), dan omzet lelang jutaan dolar, sehingga secara empiris memenuhi seluruh karakteristik aset spekulatif."
    },
    {
        "id": 9,
        "type": "jebakan",
        "badge": "Jebakan Penguji ⭐⭐⭐⭐⭐",
        "question": "Bukankah ketiga variabel X Anda berpotensi multikolinear tinggi? Misalnya pembeli yang hedonis juga ingin melengkapi koleksi.",
        "keywords": ["Process-oriented vs Goal-oriented vs Profit-oriented", "Uji validitas diskriminan", "Korelasi antar-variabel r < 0.80", "Uji VIF < 10"],
        "answer": "Secara fenomenologis ketiganya bisa dirasakan bersamaan, namun secara konseptual memiliki fokus yang sangat berbeda: Hedonic Motivation berorientasi pada proses (process-oriented / sensasi merobek pack); Desire for Completeness berorientasi pada pencapaian target (goal-oriented / menuntaskan slot binder); sedangkan Speculative Motive berorientasi pada imbal hasil finansial (profit-oriented / resale value & grading). Secara statistik, kami akan menerapkan uji validitas diskriminan, analisis korelasi antar-variabel (memastikan r < 0,80), dan uji VIF untuk memastikan tidak ada multikolinearitas yang melanggar asumsi regresi."
    },
    {
        "id": 10,
        "type": "jebakan",
        "badge": "Jebakan Penguji ⭐⭐⭐⭐⭐",
        "question": "Mengapa Anda tidak melakukan uji autokorelasi (Durbin-Watson) pada penelitian ini?",
        "keywords": ["Data survei cross-sectional", "Bukan time series", "Pengamatan independen antar-individu", "Ghozali (2018) & Gujarati (2009)"],
        "answer": "Uji autokorelasi (seperti Durbin-Watson) tidak dilakukan karena secara metodologis dan ekonometrika (Ghozali, 2018; Gujarati, 2009), autokorelasi hanya relevan untuk data deret waktu (time-series) di mana terdapat ketergantungan residual antar-periode waktu. Pada data primer kuesioner dengan desain survei cross-sectional, responden mengisi kuesioner secara independen pada satu titik waktu, sehingga asumsi non-autokorelasi terpenuhi secara alami. Uji asumsi klasik yang wajib dipenuhi adalah uji normalitas, multikolinearitas, dan heteroskedastisitas."
    },
    {
        "id": 11,
        "type": "metodologi",
        "badge": "Metodologi Sampel",
        "question": "Berapa target sampel Anda dan apa justifikasi akademisnya?",
        "keywords": ["Formula Green (1991)", "N >= 50 + 8k", "Minimal 106 responden", "Target 120-150 responden", "Cohen (1988) power 0.80 medium effect size"],
        "answer": "Target sampel ditetapkan sebanyak 120 hingga 150 responden. Angka ini didasarkan pada formula Green (1991) untuk regresi berganda dengan k=7 prediktor: N >= 50 + 8(7) = 106 responden. Target 120-150 responden juga memenuhi kaidah Cohen (1988) untuk mencapai statistical power sebesar 0,80 pada alpha = 0,05 dengan medium effect size (f2 = 0,15), serta mengantisipasi potensi kuesioner yang tidak lengkap atau tidak lolos screening."
    },
    {
        "id": 12,
        "type": "metodologi",
    ...
    },
    {
        ...
        "type": "metodologi",
        "badge": "Statistik MRA",
        "question": "Apa fungsi prosedur Mean-Centering pada model MRA?",
        "keywords": ["Eliminasi multikolinearitas struktural", "Aiken & West (1991)", "X* = X - X̄ dan M* = M - M̄", "Nilai interaksi dan p-value tetap identik"],
        "answer": "Pada model regresi moderasi, mengalikan dua variabel (X · M) secara otomatis menciptakan korelasi tinggi antara variabel interaksi dengan variabel aslinya (multikolinearitas struktural). Prosedur mean-centering (mengurangi setiap skor variabel dengan nilai rata-ratanya sebelum dikalikan) berhasil mengeliminasi multikolinearitas struktural ini sehingga nilai VIF turun di bawah 10, tanpa mengubah koefisien esensial, standard error terstandarisasi, maupun signifikansi p-value uji interaksi (Aiken & West, 1991; Ghozali, 2018)."
    },
    {
        "id": 14,
        "type": "teori",
        "badge": "Kontribusi Akademik",
        "question": "Apa novelty (kebaruan) utama dari penelitian ini dibandingkan penelitian sebelumnya?",
        "keywords": ["Integrasi 3 pemicu simultan", "Aset alternatif fisik likuid", "Self-Control sebagai moderator volisional", "Pionir TCG Indonesia FEB UKRIDA"],
        "answer": "Kebaruan utama penelitian ini terletak pada: (1) Mengintegrasikan secara simultan pemicu emosional (Hedonic), bias psikologi koleksi (Desire for Completeness / Zeigarnik Effect), dan motif spekulasi finansial (Speculative Motive / Behavioral Finance) pada komoditas hobi fisik dengan pasar sekunder aktif; (2) Memposisikan Self-Control sebagai rem volisional pemoderasi perilaku konsumtif; dan (3) Menjadi studi empiris pionir di lingkungan FEB UKRIDA yang meneliti perilaku konsumsi kartu Pokémon TCG resmi berbahasa Indonesia."
    },
    {
        "id": 15,
        "type": "teori",
        "badge": "Manfaat Penelitian",
...
QUIZ_QUESTIONS = [
    {
        "id": 1,
        "q": "Berdasarkan rujukan jurnal pemasaran internasional (Gao et al., 2014), apa istilah ilmiah baku yang menggantikan 'Need for Completion' dalam penelitian ini?",
        "options": [
            "A. Need for Achievement",
            "B. Desire for Completeness",
            "C. Compulsive Buying Tendency",
            "D. Fear of Missing Out (FOMO)"
        ],
        "ans": 1,
        "exp": "Sesuai arahan Dosen Pembimbing (9 Sep 2026) dan publikasi Gao, Huang, & Simonson (2014) di Journal of Marketing Research, istilah yang dibakukan adalah 'Desire for Completeness' yang berlandaskan pada 'The Completing the Set Effect' dan Zeigarnik Effect (1927)."
    },
    {
        "id": 2,
        "q": "Variabel moderasi dalam penelitian ini resmi ditetapkan sebagai Self-Control (Kontrol Diri). Apa alasan utama penggantian dari Literasi Keuangan?",
        "options": [
            "A. Literasi keuangan terlalu sulit dihitung di SPSS",
            "B. Self-Control bertindak sebagai rem volisional eksekutif untuk mengatasi 'knowledge-to-behavior gap'",
            "C. Literasi keuangan tidak memiliki skala pengukuran internasional",
            "D. Tidak ada teori yang menghubungkan literasi keuangan dengan belanja"
        ],
        "ans": 1,
        "exp": "Berdasarkan studi Fernandes et al. (2014) dan teori Planner-Doer Thaler & Shefrin (1981), literasi keuangan seringkali mengalami knowledge-to-behavior gap (tahu teori tapi tetap impulsif). Self-Control bertindak sebagai rem volisional eksekutif yang secara langsung menahan dorongan belanja spontan."
    },
    {
        "id": 3,
        "q": "Grand Theory yang menjadi payung utama penelitian skripsi S1 Manajemen Keuangan ini adalah...",
        "options": [
            "A. Efficient Market Hypothesis (Fama, 1970)",
            "B. Classical Economic Theory (Adam Smith)",
            "C. Behavioral Finance (Simon, 1955; Kahneman-Tversky, 1979; Shiller, 2000)",
            "D. Technology Acceptance Model (Davis, 1989)"
        ],
        "ans": 2,
        "exp": "Grand Theory yang ditetapkan adalah Behavioral Finance (Keuangan Perilaku) yang menentang asumsi rasionalitas sempurna neoklasik dan membedah anomali bias psikologis serta rasionalitas terbatas (bounded rationality) dalam pengambilan keputusan keuangan."
    },
    {
        "id": 4,
        "q": "Lembaga grading profesional seperti PSA menilai kartu fisik pada skala...",
        "options": [
            "A. Skala 1 (Poor) sampai 10 (Gem Mint)",
            "B. Skala Likert 1 sampai 5",
            "C. Skala Persentase 0% sampai 100%",
            "D. Skala Huruf A, B, C, D"
        ],
        "ans": 0,
        "exp": "Lembaga grading independen seperti PSA (Professional Sports Authenticator) menggunakan skala penilaian objektif dari 1 (Poor) hingga 10 (Gem Mint) yang disegel dalam tamper-evident slab."
    },
    {
        "id": 5,
        "q": "Mekanisme di mana kolektor membeli kartu mentah (raw card), mengirimkannya ke lembaga grading, dan menjualnya kembali dengan harga berlipat jika memperoleh nilai PSA 10 disebut...",
        "options": [
            "A. Market Cannibalization",
            "B. Grading Arbitrage (Arbitrase Grading)",
            "C. Short Selling",
            "D. Price Dumping"
        ],
        "ans": 1,
        "exp": "Fenomena ini disebut Grading Arbitrage, yaitu motif spekulasi finansial memanfaatkan disparitas harga ekstrem antara kartu mentah yang belum dinilai dengan kartu bersertifikat PSA 10 Gem Mint di pasar lelang sekunder."
    },
    {
        "id": 6,
        "q": "Mengapa hipotesis moderasi H4, H5, dan H6 dirumuskan dengan arah 'memperlemah' (-)?",
        "options": [
            "A. Karena kuesioner menggunakan skala Likert negatif",
            "B. Karena Self-Control yang tinggi bertindak sebagai rem kognitif yang meredam dampak rangsangan emosional dan motif spekulasi terhadap pembelian impulsif",
            "C. Karena jumlah responden di bawah 100 orang",
            "D. Karena dosen tidak mengizinkan hipotesis positif"
        ],
        "ans": 1,
        "exp": "Self-Regulation Theory (Baumeister, 2002) dan model Planner-Doer (Thaler & Shefrin, 1981) menjelaskan bahwa individu berkontrol diri tinggi memiliki kapasitas menunda kepuasan (delay of gratification), sehingga memperlemah pengaruh X1, X2, dan X3 terhadap Impulsive Buying."
    },
    {
        "id": 7,
        "q": "Berapa ukuran sampel minimum yang disyaratkan oleh formula Green (1991) untuk model penelitian dengan k = 7 prediktor?",
        "options": [
            "A. N >= 30 responden",
            "B. N >= 106 responden (N >= 50 + 8k)",
            "C. N >= 250 responden",
            "D. N >= 500 responden"
        ],
        "ans": 1,
        "exp": "Formula Green (1991) menyatakan N >= 50 + 8k. Untuk k = 7 prediktor (3X, 1M, dan 3 istilah interaksi X*M), ukuran sampel minimum adalah 50 + 8(7) = 106 responden. Target penelitian ditetapkan 120-150 responden."
    },
    {
        "id": 8,
        "q": "Apa tujuan utama dilakukannya prosedur 'Mean-Centering' sebelum mengalikan variabel independen dengan pemoderasi pada MRA?",
        "options": [
            "A. Mengubah data ordinal menjadi data interval",
            "B. Mengeliminasi multikolinearitas struktural antar-istilah interaksi dengan variabel aslinya",
            "C. Menaikkan nilai R-squared secara artifisial",
            "D. Menggantikan uji normalitas residual"
        ],
        "ans": 1,
        "exp": "Mean-centering (X* = X - X̄ dan M* = M - M̄) mengeliminasi multikolinearitas struktural yang timbul akibat perkalian variabel, sehingga nilai VIF turun ke batas aman tanpa mengubah substansi signifikansi moderasi (Aiken & West, 1991)."
    },
    {
        "id": 9,
        "q": "Mengapa uji autokorelasi (Durbin-Watson) TIDAK diperlukan dalam penelitian skripsi ini?",
        "options": [
            "A. Karena software SPSS tidak memiliki fitur autokorelasi",
            "B. Karena autokorelasi hanya berlaku untuk data deret waktu (time-series), sedangkan data survei primer cross-sectional bersifat independen antar-individu",
            "C. Karena data tidak berdistribusi normal",
            "D. Karena penelitian menggunakan moderasi MRA"
        ],
        "ans": 1,
        "exp": "Sesuai kaidah ekonometrika (Ghozali, 2018), autokorelasi mengukur korelasi residual antar-waktu pada data time-series. Pada penelitian survei cross-sectional dengan data primer, pengamatan antar-individu independen sehingga autokorelasi tidak relevan."
    },
    {
        "id": 10,
        "q": "Efek psikologis dari tugas yang belum tuntas yang memicu ketegangan kognitif untuk mencari penyelesaian (closure) pertama kali diteliti oleh...",
        "options": [
            "A. B.F. Skinner (1938)",
            "B. Bluma Zeigarnik (1927)",
            "C. Philip Kotler (2000)",
            "D. Robert Shiller (2000)"
        ],
        "ans": 1,
        "exp": "Zeigarnik Effect ditemukan oleh psikolog Bluma Zeigarnik pada 1927, yang membuktikan bahwa pikiran manusia secara persisten mengingat tugas belum tuntas dan menuntut penuntasan (closure)."
    },
    {
        "id": 11,
        "q": "Apa karakteristik utama yang membedakan booster pack Pokémon TCG dari produk Pokémon lainnya seperti video game atau tiket bioskop?",
        "options": [
            "A. Video game dibeli berulang kali setiap minggu",
            "B. Booster pack memiliki mekanisme blind-pack mystery yang dibeli berulang (repetitive purchase) dengan ketidakpastian isi kartu",
            "C. Kartu Pokémon tidak bisa dijual kembali",
            "D. Booster pack hanya bisa dibeli di Jepang"
        ],
        "ans": 1,
        "exp": "Video game atau tiket film adalah one-off purchase (dibeli sekali selesai). Sebaliknya, booster pack adalah repetitive purchase yang dipicu oleh ketidakpastian blind-pack mystery (probabilitas gacha/lotre)."
    },
    {
        "id": 12,
        "q": "Dalam sistematika penulisan BAB II Tinjauan Pustaka sesuai arahan Dosen Pembimbing, urutan pembahasan variabel yang benar adalah...",
        "options": [
            "A. Variabel Moderasi (M) lebih dulu -> Variabel Independen (X) -> Variabel Dependen (Y)",
            "B. Variabel Dependen (Y - Impulsive Buying) lebih dulu -> Variabel X1, X2, X3 -> Variabel Moderasi (M) -> Pengembangan Hipotesis",
            "C. Hipotesis lebih dulu -> Definisi Teori -> Data Lapangan",
            "D. Variabel X1 langsung ke hipotesis tanpa membahas Y"
        ],
        "ans": 1,
        "exp": "Arahan Dosen Pembimbing menetapkan variabel dependen (Y - Impulsive Buying) dibahas terlebih dahulu sebagai masalah inti penelitian, disusul variabel penjelas (X1, X2, X3), variabel pemoderasi (M), dan sintesis pengembangan hipotesis 4-tier."
    },
    {
        "id": 13,
    ...
    {
        "id": 14,
        "q": "Berdasarkan meta-analisis Amos et al. (2014), pemicu pembelian impulsif dikelompokkan ke dalam 3 klaster faktor. Variabel apa yang mewakili faktor kognitif kolektor?",
        "options": [
            "A. Hedonic Motivation (X1)",
            "B. Speculative Motive (X3)",
            "C. Desire for Completeness (X2)",
            "D. Self-Control (M)"
        ],
        "ans": 2,
        "exp": "Amos et al. (2014) memetakan 3 klaster: Afektif/Emosional diwakili Hedonic Motivation (X1); Kognitif Kolektor diwakili Desire for Completeness (X2); dan Situasional/Ekonomi diwakili Speculative Motive (X3)."
    },
    {
        "id": 15,
        "q": "Tingkat kelangkaan kartu Pokémon TCG resmi Indonesia yang memiliki nilai pasar sekunder termahal dan menjadi target utama arbitrase grading adalah...",
        "options": [
            "A. Common (C)",
            "B. Uncommon (U)",
            "C. Special Illustration Rare (SAR)",
            "D. Basic Energy"
        ],
        "ans": 2,
...
CSS_CONTENT = """/* ==========================================================================
   PRESENTASI PANDUAN BELAJAR SKRIPSI FEB UKRIDA
   Modern Academic FinTech Dark System with Pokémon Electric Gold Accents
   ========================================================================== */
...
body {
  ...
  background-image: 
    ...
    radial-gradient(at 100% 0%, rgba(6, 78, 59, 0.35) 0px, transparent 50%),
...
.feature-card.gold .feature-icon { background: var(--accent-gold-glow); color: var(--accent-gold); }
.feature-card.blue .feature-icon { background: var(--accent-blue-glow); color: var(--accent-blue); }
.feature-card.emerald .feature-icon { background: var(--accent-emerald-glow); color: var(--accent-emerald); }
.feature-card.purple .feature-icon { background: var(--accent-purple-glow); color: var(--accent-purple); }
.feature-card.rose .feature-icon { background: var(--accent-rose-glow); color: var(--accent-rose); }
...
.card-badge.blue { background: var(--accent-blue-glow); color: #60a5fa; border: 1px solid #3b82f6; }
.card-badge.green { background: var(--accent-emerald-glow); color: #34d399; border: 1px solid #10b981; }
.card-badge.yellow { background: var(--accent-gold-glow); color: #fbbf24; border: 1px solid #f59e0b; }
.card-badge.red { background: var(--accent-rose-glow); color: #f87171; border: 1px solid #ef4444; }
...
@media (max-width: 900px) {
  .slide-grid-2, .slide-grid-3, .mra-calc-grid {
...
JS_TEMPLATE = """// PANDUAN BELAJAR SKRIPSI FEB UKRIDA - APPLICATION ENGINE
...
<head>
  ...
  <title>Panduan Belajar & Penguasaan Sidang Proposal Skripsi — FEB UKRIDA</title>
  
  <!-- Google Fonts -->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;600;700&family=Outfit:wght@400;600;700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">
...
<body>
  ...
  <header class="app-header">
    <div class="brand-wrapper">
      <div class="brand-badge">FEB UKRIDA</div>
      <div class="brand-title">
        Proposal Skripsi <span>• Pokémon TCG</span>
      </div>
    </div>

    <!-- Mode Switcher Tabs -->
    <nav class="nav-tabs">
      <button class="nav-tab-btn active" data-tab="tab-presentation">🖥️ Slide Presentasi</button>
      <button class="nav-tab-btn" data-tab="tab-flashcards">🃏 Flashcard 3D</button>
      <button class="nav-tab-btn" data-tab="tab-defense">🎯 Simulasi Sidang</button>
      <button class="nav-tab-btn" data-tab="tab-quiz">📝 Kuis Evaluasi</button>
      <button class="nav-tab-btn" data-tab="tab-mra">📊 Visualisator MRA</button>
    </nav>

    <!-- Header Controls: Timer & Fullscreen -->
    <div class="header-controls">
      <div class="timer-box" title="Timer Latihan Presentasi 15 Menit">
        <span>⏱️</span>
        <span id="timer-display">15:00</span>
        <button class="timer-btn" id="timer-toggle-btn">▶</button>
        <button class="timer-btn" id="timer-reset-btn">↺</button>
      </div>
      <button class="btn-icon" id="fullscreen-btn" title="Fullscreen (F)" onclick="toggleFullscreen()">⛶</button>
    </div>
  </header>
  ...
  <main class="app-main">
    ...
    <!-- TAB 1: SLIDE PRESENTATION DECK -->
    <section id="tab-presentation" class="tab-section active">
      <div class="presentation-viewport">
        
        <div class="slide-container">
          <div class="slide-header">
            <div>
              <span class="slide-tag" id="slide-tag">COVER & IDENTITAS</span>
              <h2 class="slide-title" id="slide-title">Judul Slide</h2>
              <div class="slide-subtitle" id="slide-subtitle">Subjudul slide</div>
            </div>
            <div class="slide-meta-right">
              <span class="slide-number-badge" id="slide-num-text">1 / 12</span>
            </div>
          </div>

          <div class="slide-body" id="slide-render-area">
        ...
        <div class="notes-drawer" id="notes-drawer">
          <div class="notes-title">🎙️ Catatan Pembicara (Tekan 'N' untuk sembunyikan):</div>
          <div class="notes-content" id="notes-text">Catatan pembicara akan muncul di sini.</div>
        </div>

        <!-- Deck Toolbar Controls -->
        <div class="deck-toolbar">
          <button class="deck-nav-btn" id="deck-prev-btn">◀ Sebelumnya</button>
          
          <div class="deck-progress-wrapper">
            <div class="deck-progress-bar">
              <div class="deck-progress-fill" id="deck-progress-fill" style="width: 8.33%;"></div>
            </div>
            <span class="deck-indicator-text" id="deck-progress-label">8% SELESAI</span>
          </div>

          <div style="display: flex; gap: 0.5rem;">
            <button class="deck-nav-btn" id="notes-toggle-btn" title="Lihat Catatan Pembicara (N)">📝 Catatan (N)</button>
            <button class="deck-nav-btn" id="deck-next-btn">Selanjutnya ▶</button>
          </div>
        </div>
    ...
    <!-- TAB 2: FLASHCARD STUDIO 3D -->
    <section id="tab-flashcards" class="tab-section">
      <div class="flashcard-section">
        
        <div class="section-topbar">
          <div>
            <h2 style="font-family:var(--font-heading); font-size:1.5rem; font-weight:800;">Flashcard Istilah & Teori Kunci</h2>
            <p style="color:var(--text-secondary); font-size:0.9rem;">Klik kartu atau tekan Spasi untuk membalik (Front: Istilah, Back: Definisi & Landasan Ilmiah).</p>
          </div>
          <div class="filter-group" id="fc-filter-group">
            <!-- Filter buttons -->
          </div>
        </div>

        <!-- Progress Tracker -->
        <div style="background:var(--bg-glass-card); padding:0.75rem 1.25rem; border-radius:var(--radius-md); border:1px solid var(--border-subtle); display:flex; align-items:center; justify-content:space-between;">
          <span style="font-size:0.85rem; font-weight:600;" id="fc-mastery-label">0 / 26 DIKUASAI (0%)</span>
          <div style="width: 200px; height: 6px; background: rgba(255,255,255,0.1); border-radius: var(--radius-full); overflow:hidden;">
            <div id="fc-progress-fill" style="width: 0%; height:100%; background:var(--accent-emerald); transition:width 0.3s ease;"></div>
          </div>
          <span id="fc-status-pill" style="font-size:0.85rem; font-weight:700;">Belum Dikuasai ⏳</span>
        </div>

        <!-- 3D Card Stage -->
        <div class="card-stage">
          <div class="flashcard-3d" id="main-flashcard">
            <!-- Front Face -->
            <div class="card-face card-front">
              <span class="card-badge blue" id="fc-badge-front">Variabel Y</span>
              <div class="card-main-term" id="fc-front-term">Impulsive Buying</div>
              <div class="card-flip-prompt">🔄 Klik kartu untuk melihat definisi & sumber ilmiah</div>
            </div>

            <!-- Back Face -->
            <div class="card-face card-back">
              <div style="display:flex; justify-content:space-between; align-items:center;">
                <span class="card-badge blue" id="fc-badge-back">Variabel Y</span>
                <span class="card-author" id="fc-back-author">Rook (1987)</span>
              </div>
              <div class="card-desc" id="fc-back-desc">
                Definisi variabel akan muncul di sini.
              </div>
              <div class="card-flip-prompt">🔄 Klik kartu untuk kembali ke depan</div>
            </div>
          </div>

          <!-- Flashcard Actions -->
          <div class="flashcard-action-bar">
            <button class="btn-fc repeat" id="fc-repeat-btn">🔁 Perlu Ulang</button>
            <div class="fc-nav-controls">
              <button class="timer-btn" id="fc-prev-btn">◀</button>
              <span id="fc-indicator">1 / 26</span>
              <button class="timer-btn" id="fc-next-btn">▶</button>
            </div>
            <button class="btn-fc mastered" id="fc-master-btn">✅ Sudah Paham</button>
          </div>
        </div>
    ...
    <!-- TAB 3: SIMULASI TANYA JAWAB SIDANG -->
    <section id="tab-defense" class="tab-section">
      <div style="display:flex; flex-direction:column; gap:1.25rem;">
        <div class="section-topbar">
          <div>
            <h2 style="font-family:var(--font-heading); font-size:1.5rem; font-weight:800;">Simulasi Pertanyaan Bimbingan & Sidang</h2>
            <p style="color:var(--text-secondary); font-size:0.9rem;">15 Arahan Kritis Pembimbing + 5 Pertanyaan Jebakan Penguji Level ⭐⭐⭐⭐⭐.</p>
          </div>
          <div style="width: 100%; max-width: 350px;">
            <input type="text" id="qa-search-input" placeholder="🔍 Cari topik atau kata kunci..." style="width:100%; background:var(--bg-surface-elevated); border:1px solid var(--border-subtle); padding:0.5rem 1rem; border-radius:var(--radius-md); color:#fff; font-family:var(--font-body); font-size:0.9rem;">
          </div>
        </div>

        <div class="defense-list" id="qa-list-container">
          <!-- Injected by JavaScript -->
        </div>
      </div>
    </section>

    <!-- TAB 4: KUIS EVALUASI INTERAKTIF -->
    <section id="tab-quiz" class="tab-section">
      <div class="quiz-container">
        
        <div id="quiz-active-view" class="quiz-card">
          <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid var(--border-subtle); padding-bottom:0.75rem;">
            <span style="font-family:var(--font-mono); font-size:0.85rem; color:var(--accent-gold);" id="quiz-progress-label">Soal 1 dari 15</span>
            <div style="width: 150px; height: 6px; background: rgba(255,255,255,0.1); border-radius: var(--radius-full); overflow:hidden;">
              <div id="quiz-progress-fill" style="width: 6.6%; height:100%; background:var(--accent-gold); transition:width 0.3s ease;"></div>
            </div>
          </div>

          <div class="quiz-q-text" id="quiz-question-text">
          ...
          <div class="quiz-explanation-box" id="quiz-explanation-box">
            <div class="quiz-exp-title">💡 Pembahasan Akademis:</div>
            <div class="quiz-exp-text" id="quiz-exp-text">Penjelasan jawaban benar.</div>
          </div>

          <div style="display:flex; justify-content:flex-end;">
            <button class="deck-nav-btn" id="quiz-next-btn" style="display:none; background:var(--accent-gold); color:#000;">
              Soal Selanjutnya ▶
            </button>
          </div>
        </div>
        ...
        <!-- Result View -->
        <div id="quiz-result-view" class="quiz-card quiz-result-view" style="display:none;">
          <h2 style="font-family:var(--font-heading); font-size:1.8rem; font-weight:800; margin-bottom:1rem;">Hasil Kuis Evaluasi Sidang</h2>
          <div class="score-circle" id="quiz-final-score">0</div>
          <p style="font-size:1.1rem; color:var(--text-primary); max-width:600px; margin:0 auto 1.5rem auto;" id="quiz-grade-text">
            Evaluasi hasil Anda.
          </p>
          <button class="btn-fc mastered" id="quiz-restart-btn" style="margin: 0 auto;">
            ↺ Ulangi Kuis
          </button>
        </div>
    ...
    <!-- TAB 5: VISUALISATOR MRA (SLOPES CALCULATOR) -->
    <section id="tab-mra" class="tab-section">
      <div style="display:flex; flex-direction:column; gap:1.5rem;">
        <div class="section-topbar">
          <div>
            <h2 style="font-family:var(--font-heading); font-size:1.5rem; font-weight:800;">Visualisator Efek Moderasi MRA (Simple Slopes)</h2>
            <p style="color:var(--text-secondary); font-size:0.9rem;">Simulasi matematis bagaimana Self-Control (M) memperlemah kemiringan garis regresi X terhadap Y.</p>
          </div>
        </div>

        <div class="mra-calc-grid">
          <!-- Control Panel -->
          <div class="calc-panel">
            <h3 style="font-family:var(--font-heading); font-size:1.1rem; color:#fff;">Kontrol Parameter Model</h3>

            <div class="slider-group">
              <label style="font-size:0.85rem; color:var(--text-muted);">Pilih Variabel Independen (X):</label>
              <select id="mra-var-select" style="background:var(--bg-surface); border:1px solid var(--border-subtle); color:#fff; padding:0.6rem; border-radius:var(--radius-sm); font-family:var(--font-body);">
                <option value="Hedonic Motivation">X1: Hedonic Motivation</option>
                <option value="Desire for Completeness">X2: Desire for Completeness</option>
                <option value="Speculative Motive">X3: Speculative Motive</option>
              </select>
            </div>

            <div class="slider-group">
              <div class="slider-header">
                <label style="color:var(--text-muted);">Tingkat Self-Control (M):</label>
                <span id="mra-mod-val-label">Rata-Rata (Mean)</span>
              </div>
              <input type="range" id="mra-mod-slider" class="slider-range" min="-1" max="1" step="0.1" value="0">
              <div style="display:flex; justify-content:space-between; font-size:0.75rem; color:var(--text-muted);">
                <span>-1 SD (Rendah)</span>
                <span>0 (Mean)</span>
                <span>+1 SD (Tinggi)</span>
              </div>
            </div>

            <div class="callout-box" style="margin-top:0.5rem;">
              <div class="callout-title">Bukti Hipotesis:</div>
              <div class="callout-desc" id="mra-slope-desc">
                Ketika Self-Control tinggi, kemiringan garis melandai (memperlemah efek).
              </div>
            </div>
          </div>
          ...
          <div class="plot-panel">
            <svg id="mra-slopes-svg" viewBox="0 0 420 280" style="width:100%; max-width:480px; height:auto;"></svg>
          </div>
        </div>
      </div>
    </section>
  ...
  <footer class="app-footer">
    <span>Proposal Skripsi S1 Manajemen Keuangan FEB UKRIDA © 2026 Arthur Reezan (NIM: 322015175) • Disinkronisasi dengan Buku Pedoman 2022/2023 & Arahan Dosen 9 Sep 2026</span>
  </footer>
...
def main():
    print("Mengeksekusi pembuatan aplikasi web presentasi interaktif...")
    
    # Generate JS content with injected JSON data
    slides_json = json.dumps(SLIDES_DATA, ensure_ascii=False)
    fc_json = json.dumps(FLASHCARDS_DATA, ensure_ascii=False)
    qa_json = json.dumps(DEFENSE_QUESTIONS, ensure_ascii=False)
    quiz_json = json.dumps(QUIZ_QUESTIONS, ensure_ascii=False)

    js_content = JS_TEMPLATE
    js_content = js_content.replace("__SLIDES_JSON__", slides_json)
    js_content = js_content.replace("__FLASHCARDS_JSON__", fc_json)
    js_content = js_content.replace("__QUESTIONS_JSON__", qa_json)
    js_content = js_content.replace("__QUIZ_JSON__", quiz_json)

    # 1. Tulis style.css
    css_path = os.path.join(OUTPUT_DIR, "style.css")
    with open(css_path, "w", encoding="utf-8") as f:
        f.write(CSS_CONTENT)
    print(f"-> Berhasil membuat: {css_path}")

    # 2. Tulis app.js
    js_path = os.path.join(OUTPUT_DIR, "app.js")
    with open(js_path, "w", encoding="utf-8") as f:
        f.write(js_content)
    print(f"-> Berhasil membuat: {js_path}")

    # 3. Tulis index.html modular
    index_path = os.path.join(OUTPUT_DIR, "index.html")
    index_html = HTML_BODY.replace("__CSS_PLACEHOLDER__", '<link rel="stylesheet" href="style.css">')
    index_html = index_html.replace("__JS_PLACEHOLDER__", '<script src="app.js"></script>')
    with open(index_path, "w", encoding="utf-8") as f:
        f.write(index_html)
    print(f"-> Berhasil membuat: {index_path}")

    # 4. Tulis PRESENTASI_PANDUAN_BELAJAR.html standalone bundle (All-in-one double-clickable)
    standalone_html = HTML_BODY.replace("__CSS_PLACEHOLDER__", f"<style>\n{CSS_CONTENT}\n</style>")
    standalone_html = standalone_html.replace("__JS_PLACEHOLDER__", f"<script>\n{js_content}\n</script>")
    with open(STANDALONE_FILE, "w", encoding="utf-8") as f:
        f.write(standalone_html)
    print(f"-> Berhasil membuat standalone bundle: {STANDALONE_FILE}")

    print("\nSemua berkas presentasi web interaktif berhasil digenerasi 100%!")
