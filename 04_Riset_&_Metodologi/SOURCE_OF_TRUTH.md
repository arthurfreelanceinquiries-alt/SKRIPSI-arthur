...
| **D09** | Pembakuan Istilah $X_2$ menjadi ***Desire for Completeness*** | 9 Sep 2026 | Arahan Dosen: cari istilah ilmiah baku (Gao, Huang, & Simonson, 2014, *JM*; Barasz et al., 2017, *JEP: General*; Belk, 1995; Zeigarnik, 1927). |
...
| **D14** | Standardisasi Format Pedoman FEB UKRIDA 2023 | 15 Sep 2026 | Mengikat seluruh format naskah ke SK Dekan No. 350a/SK/UKKW/FEB/D/VI/2023 (margin 4-3-3-3 cm, TNR 12pt, spasi 1.5, in-text citation 'dan', tanpa penomoran angka di Daftar Pustaka). |
| **D15** | Pemenuhan Kewajiban Sitasi Dosen K-04 | 15 Sep 2026 | Wajib mensitasi artikel Dr. Fredella Colline (2024) di Bab 1, 2, dan 3 sebagai pemenuhan syarat Pedoman UKRIDA Subbab 1.4.b. |
| **D16** | Kuota Minimal Jurnal Bereputasi SINTA & Scopus | 15 Sep 2026 | Menjamin minimal 5 artikel empiris mutakhir terindeks (realisasi: 3 SINTA + 4 Scopus Q1/WOS = 7 artikel). |
| **D17** | Format Daftar Pustaka Alfabetis Murni Bebas Angka | 15 Sep 2026 | Menghilangkan seluruh nomor urut `1.` s.d. `51.` pada daftar pustaka Word/Markdown sesuai Subbab 3.7 Pedoman 2023 (*hanging indent* 1,25 cm). |
| **D18** | Model MRA 2-Tahap Hierarkis Baseline (Resolusi Prism AI) | 14 Sep 2026 | Model 1 menyertakan pemoderasi $M$ sebagai prediktor langsung ($Y = \alpha + \beta_1 X_1 + \beta_2 X_2 + \beta_3 X_3 + \beta_4 M + e$) agar $\Delta R^2$ pada Model 2 murni mengukur interaksi moderasi. |
| **D19** | Kebijakan Tata Kelola Skill `paper-audit` (Tier-3 Gated Milestone) | 16 Sep 2026 | `paper-audit` dijalankan pada milestone strategis (Pra-Bimbingan, Pra-Sempro, Pasca-Revisi Mayor), bukan di setiap edit kecil. |
...
| **D21** | Kebijakan Paritas 1:1 Mendeley & Whitelist Tag RIS | 16 Sep 2026 | Mengunci paritas referensi (TeX == Word == MD == RIS == Bib == Mendeley UI; 56 pada 16 Sep pagi → 55 pasca-eliminasi ICv2 → **54 pasca-hapus ghost Tan & Prasetio + pengganti Azizah 18 Sep 2026**), memblokir total tag ilegal `ELEC`/`WEB` untuk mengeliminasi bahaya *Silent Drop*, serta menetapkan tag `RPRT` untuk seluruh data industri. |
...
## 4. Matriks 7 Subjek Hubungan Empiris & Research Gap (14 Studi Berlawanan)

| No | Subjek Hubungan | Kelompok Temuan A (Positif / Signifikan) | Kelompok Temuan B (Negatif / Tidak Signifikan) | Penjelasan "Mengapa Terjadi Gap" (*The Why*) |
|:---:|:---|:---|:---|:---|
| **1** | **$X_1$ (*Hedonic Motivation*) $\rightarrow Y$ (*Impulsive Buying*)** | Arnold & Reynolds (2003); Gültekin & Özer (2012); Pranggabayu & Andjarwati (2022); Gong et al. (2024); Tirtayasa et al. (2020); Zheng et al. (2019, dipindah ke Temuan A per audit F001) | Batas konseptual Thaler (mental budgeting): dorongan tertahan anggaran ketat (bukan klaim n.s.) | **Karakteristik Komoditas (Utilitarian vs Hedonik Gacha):** Pada produk konsumsi utiliter, motivasi hedonis mudah ditekan oleh anggaran. Pada komoditas kejutan (*mystery pack*) Pokémon TCG, sensasi merobek kemasan memicu dopamin afektif yang melumpuhkan rem pertimbangan rasional. |
| **2** | **$X_2$ (*Desire for Completeness*) $\rightarrow Y$ (*Impulsive Buying*)** | Gao, Huang, & Simonson (2014); Barasz et al. (2017); Dewi et al. (2026) | Long & Schiffman (2000); Spero & Stone (2004) (argumen teoritis kolektor matang, bukan uji n.s.) | **Kematangan Kolektor (*Collector Maturity*):** Kolektor pemula mengalami ketegangan kognitif tinggi saat binder berlubang sehingga terburu-buru belanja pack acak. Kolektor senior lebih sabar dan terencana membeli kartu satuan (*single cards*) di pasar sekunder. |
| **3** | **$X_3$ (*Speculative Motive*) $\rightarrow Y$ (*Impulsive Buying*)** | Baur et al. (2018); Aryadi & Lingga (2024, analogi partisipasi investasi); Colline (2024, analogi herding kualitatif) | Barber & Odean (2008); Fama (1970) (analogi saham, bukan bukti n.s. kolektibel) | **Ilusi Probabilitas vs Kehati-hatian Risiko:** Euforia harga fantastis kartu *PSA 10 Gem Mint* memicu bias optimisme dan ilusi lotre (*gambler's fallacy*). Sebaliknya, investor sadar risiko (*risk-averse*) menahan diri dari pembelian spontan tanpa kalkulasi matematis. |
| **4** | **$M$ (*Self-Control*) $\rightarrow Y$ (*Impulsive Buying*) [Direct Baseline]** | Baumeister (2002); Tangney et al. (2004); Vohs & Faber (2007); Sultan, Joireman, & Sprott (2012, isi paywalled — klaim setingkat-judul) | Hirschman (1982); Stern (1962) (batas konseptual *cognitive bypass*, bukan uji regresi) | **Kapasitas Volisional vs Terkurasnya Ego (*Ego Depletion*):** Kontrol diri meredam impulsif saat energi mental prima. Namun saat terjadi *ego depletion* atau rangsangan sensori instan di kasir minimarket (*visceral urge*), rem volisional gagal menahan desakan impulsif. |
| **5** | **Moderasi $M$ (*Self-Control*) pada $X_1 \rightarrow Y$** | Lienardy & Panasea (2026, MRA genuine H4); Katauke et al. (2023, regulasi-literasi tak langsung) | Apidana & Kholifah (2022, H3 ditolak p=0,597); Artadita & Firmialy (2024, H3 ditolak β=0,092 n.s.) + teori *regulatory failure* | **Ambang Intensitas Hedonis:** Moderasi bekerja pada dorongan moderat (Lienardy); pada euforia ekstrem, rem jebol (Apidana, Artadita) — pasangan gagal-moderasi genuine. |
| **6** | **Moderasi $M$ (*Self-Control*) pada $X_2 \rightarrow Y$** | Parsial/tak langsung: Artadita & Firmialy (2024, kontrol kognitif 10%); Apidana & Kholifah (2022, buffer lifestyle) — uji $X_2 \cdot M$ langsung belum tersedia | Belk (1995); Barasz et al. (2017) (teori obsesi) + Artadita H3 ditolak (gagal-moderasi koleksi) | **Keterikatan Kolektor:** Bukti langsung belum ada; justifikasi H5 bertumpu pada parsial + teori + kebutuhan pengujian (inilah gap-nya). |
| **7** | **Moderasi $M$ (*Self-Control*) pada $X_3 \rightarrow Y$** | Tak langsung: Katauke et al. (2023, literasi menekan impulsivitas) + mekanisme *Planner-Doer* — uji $X_3 \cdot M$ langsung belum tersedia | Shiller (2000, teori gelembung); Aryadi & Lingga (2024, partisipasi TCG bukan uji interaksi) | **Histeria Gelembung Pasar:** Klaim moderasi pada spekulasi adalah hipotesis yang diuji H6; justifikasi bertumpu pada regulasi-umum + teori (inilah gap-nya). |
...
- [x] **K-02 Min. 50 Halaman:** Naskah proposal `.tex` sudah 48 halaman; target TA lengkap >100 halaman.
- [x] **K-03 Min. 5 Jurnal:** Sudah >30 jurnal bereputasi (SINTA, Scopus) di `references.bib`
- [x] **K-04 Sitasi Dosen FEB UKRIDA:** **TERPENUHI ✓** — Mengutip Dr. Fredella Colline (2024), *"Biases in Indonesian Stock Investor Behavior"*, *Accounting and Finance Studies*, disitasi dalam BAB I, BAB II, dan BAB III.
...
## 7. Catatan Keputusan Revisi Metodologi Terkini (September 2026)

Berdasarkan telaah kritis terhadap arahan Dosen Pembimbing (Dr. Fredella Colline):

| Kode | Keputusan Metodologis | Rasional & Implementasi Ilmiah |
|:---|:---|:---|
| **D14** | **Pemetaan Deduktif Anteseden $Y$ di Bab 1** | Menguraikan variabel dependen ($Y$: *Impulsive Buying*) terlebih dahulu, memetakan 4 rumpun anteseden dari literatur (Afektif, Kognitif/Kolektor, Spekulasi Pasar, dan Rangsangan Toko), lalu menjustifikasi secara deduktif pemilihan $X_1, X_2, X_3$ berdasarkan karakteristik produk. Memetakan skala pengukuran $Y$ (Rook & Fisher 1995 vs Beatty & Ferrell 1998 vs Verplanken & Herabadi 2001) sebelum menetapkan sintesis instrumen Verplanken & Herabadi + Rook. |
| **D15** | **Struktur Rumusan Masalah 6 Butir Direksional (3 Direct + 3 Moderasi Memperlemah)** | Revisi audit paper-audit 17 Sep 2026 (F016): RM4–RM6 dan T4–T6 ditulis direksional eksplisit ``memoderasi (memperlemah)'' selaras H4–H6 ($\beta_5,\beta_6,\beta_7<0$); uji dua sisi konservatif + interpretasi tanda. Hipotesis tetap 6 (H1–H3 langsung, H4–H6 moderasi). |
| **D16** | **Relokasi Batasan Penelitian ke Bab 3** | Sesuai Buku Pedoman Tugas Akhir FEB UKRIDA Model B, subbab Batasan Masalah dipindahkan dari Bab 1 ke Bab 3 (Subbab 3.1.1) mencakup Batasan Komoditas Objek, Batasan Responden, dan Batasan Konseptual/Metodologis. Bab 1 hanya memuat 4 subbab baku: 1.1 Latar Belakang, 1.2 Perumusan Masalah, 1.3 Tujuan, 1.4 Manfaat. |
| **D17** | **Rigoritas Justifikasi Kriteria Inklusi & Komparasi Sampling** | Memberikan dasar hukum dan psikologis pada kriteria inklusi: (1) Usia $\ge 17$ tahun (KUHPerdata Ps. 330, kepemilikan KTP, dan diskresi keuangan mandiri); (2) Pembelian 6–12 bulan terakhir (menghindari distorsi ingatan / *recall bias*). Menjelaskan secara komparatif alasan pemilihan *Purposive Sampling* dibanding *Probability Sampling* (ketiadaan *sampling frame* terpusat). |
| **D18** | **Justifikasi Komparatif MRA OLS & Visualisasi Alur/Jadwal** | Membandingkan MRA OLS *mean-centering* vs SEM (Hair et al., 2019; Hayes, 2018), membuktikan MRA OLS paling cocok untuk skala komposit dan sampel 120–150 tanpa risiko *over-parameterization*. Menambahkan visualisasi Diagram Alur Pelaksanaan Penelitian (TikZ 2-kolom / Mermaid) dan Jadwal Pelaksanaan Penelitian matriks 6 bulan (Gantt Chart). |
| **D19** | **Kepatuhan Jurnal Empiris Terkini (2021--2026) & Verifikasi Google Scholar / Mendeley** | Membedakan secara tegas ranah literatur: (1) Grand theory & skala psikometri asli (Kahneman 1979, Mehrabian & Russell 1974, Rook 1987, Tangney 2004, Gao 2014, dll.) diperbolehkan dan wajib merujuk ke karya klasik/seminal; (2) **Penelitian Empiris Terkini (Tabel 2.1, maksimal 5 tahun: 2021--2026)** dan 100% terindeks serta dapat dilacak di Google Scholar, Mendeley, SINTA, atau Scopus. Seluruh 10 baris Tabel 2.1 diaudit dan diisi oleh 10 artikel empiris terkini yang terverifikasi: Pranggabayu & Andjarwati (2022), Apidana & Kholifah (2022), Lienardy & Panasea (2026 - BIREV 4(3), koreksi tahun 18 Sep 2026), Gong et al. (2024 - Heliyon Scopus Q1), Azizah & Fauzi (2025 - JIKO UMM, pengganti ghost Tan & Adyantari per audit 18 Sep 2026), Dewi et al. (2026 - Locus 5(2), koreksi tahun 18 Sep 2026), Aryadi & Lingga (2024 - Atlantis Press / Springer TCG Community Jakarta, koreksi DOI 18 Sep 2026), Colline (2024 - FEB UKRIDA K-04), Artadita & Firmialy (2024 - BBR Scopus Q3 / SINTA 1), dan Katauke et al. (2023 - Sustainability Q1). Ghost kedua `prasetio2021hedonic` (DOI milik artikel lain, judul tak ada di Crossref) juga dihapus dari Bab 2 pada audit yang sama.
| **D21** | **Paritas Mutlak 1:1 Mendeley 56 Referensi & Whitelist RIS** | Mengatasi insiden *silent drop* Mendeley (ELEC/WEB diabaikan Mendeley) dengan menerapkan whitelist ketat (`JOUR`, `BOOK`, `CONF`, `RPRT`). Mengunci paritas 1:1 tepat 56 referensi di seluruh 6 media: naskah LaTeX, naskah Word, Markdown master, berkas RIS, berkas BibTeX, dan antarmuka Mendeley UI. Divalidasi oleh test suite `verify_mendeley_integrity.py`. |
| **D22** | **Standarisasi URL Sitasi APA 7th Edition Data Pokémon** | Menyertakan tautan resmi untuk 4 rujukan data industri Pokémon (`pokemoncompany2024`, `statista2024pokemon`, `icv2tcgplayer2024`, `psa2024popreport`) dalam bentuk `<w:hyperlink>` aktif berwarna biru di Word, `\url{...}` di LaTeX/PDF, dan tag `UR  - ` di berkas RIS Mendeley sesuai standar APA 7th Edition. |
| **D23** | **Audit & Koreksi Tautan URL Aktif Bebas 404 & Misdirection** | Berdasarkan umpan balik dan pengujian langsung pada peramban web: (1) Mengoreksi URL The Pokémon Company dari `/aboutus/data/` (yang menghasilkan error 404 Chameleon) menjadi portal resmi aktif `https://corporate.pokemon.co.jp/en/aboutus/figures/`; (2) Mengoreksi URL Statista dari `/chart/26439/` (yang mengarah ke infografis energi nuklir Asia) menjadi infografis resmi Pokémon `https://www.statista.com/chart/24277/media-franchises-with-most-sales/` ("The Pokémon Franchise Caught 'Em All", US$ 100B #1 Media Franchise). |
